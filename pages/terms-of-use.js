...
export default function TermsOfUse() {
  return (
    <Page>
      <Head>
        <title>Terms of Use | Flood & Fire Solutions</title>
        <meta
          name="description"
          content="Terms of Use for floodandfiresolutions.com"
        />
        <meta name="robots" content="noindex" />
        <link
          rel="canonical"
          href="https://floodandfiresolutions.com/terms-of-use"
        />
      </Head>
      <div className="terms">
        <section className="format-text">
          ...
          <p>
            ...
            materials (information or software) on Flood & Fire Solutions’s web
          ...
          <p>
            ...
            these restrictions and may be terminated by Flood & Fire Solutions
          ...
          <h2>3. Disclaimer</h2>
          <p>
            The materials on Flood & Fire Solutions’s web site are provided “as
            is”. Flood & Fire Solutions makes no warranties, expressed or
          ...
          <h2>4. Limitations</h2>
          <p>
            In no event shall Flood & Fire Solutions or its suppliers be liable
            ...
            use or inability to use the materials on Flood & Fire Solutions’s
            Internet site, even if Flood & Fire Solutions or a Flood & Fire
            Solutions authorized representative has been notified orally or in
          ...
          <p>
            The materials appearing on Flood & Fire Solutions’s web site could
            include technical, typographical, or photographic errors. Flood &
            Fire Solutions does not warrant that any of the materials on its web
            site are accurate, complete, or current. Flood & Fire Solutions may
            make changes to the materials contained on its web site at any time
            without notice. Flood & Fire Solutions does not, however, make any
            commitment to update the materials.
          </p>
          <h2>6. Links</h2>
          <p>
            Flood & Fire Solutions has not reviewed all of the sites linked to
